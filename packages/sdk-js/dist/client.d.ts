...
export declare class VerisClient {
   ...
   */
  triggerSnapshotAutomation(
    action?: "check" | "status" | "verify" | "stats" | "cleanup",
    keep?: number,
   ...
   */
  runSchemaRegressionTests(action?: "run" | "check"): Promise<
    | SchemaRegressionCheck
    | {
        results: any[];
      }
   ...
   */
  runRecoveryAudit(
    action?: "check" | "run" | "status" | "history" | "results" | "cross-mirror",
    enhanced?: boolean,
    options?: {
      limit?: number;
      date?: string;
