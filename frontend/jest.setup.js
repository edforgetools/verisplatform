...
process.env.supabaseservicekey = process.env.supabaseservicekey || "test-service-key-1234567890";
process.env.STRIPE_SECRET_KEY = process.env.STRIPE_SECRET_KEY || "sk_test_1234567890";
process.env.STRIPE_WEBHOOK_SECRET = process.env.STRIPE_WEBHOOK_SECRET || "whsec_test_1234567890";
