...
async function handlePhase1Metrics(req: NextRequest) {
  try {
    ...
    if (metricsError && metricsError.code !== "PGRST116") {
      ...
      return jsonErr("DB_ERROR", "Failed to get Phase-1 metrics", "metrics-phase1", 500);
    }
    ...
    if (gatesError && gatesError.code !== "PGRST116") {
      ...
      return jsonErr("DB_ERROR", "Failed to get Phase-1 gates", "metrics-phase1", 500);
    }
    ...
    return jsonErr("INTERNAL_ERROR", "Internal server error", "metrics-phase1", 500);
  }
}
